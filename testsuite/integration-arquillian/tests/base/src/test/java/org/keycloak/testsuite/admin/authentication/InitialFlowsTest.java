...
public class InitialFlowsTest extends AbstractAuthenticationTest {
    ...
    private LinkedList<FlowExecutions> expectedFlows() {
        ...
        addExecInfo(execs, "Name Validation", "registration-name-action", false, 1, 1, REQUIRED, null, new String[]{REQUIRED, DISABLED});
        addExecInfo(execs, "Email Validation", "registration-email-action", false, 1, 2, REQUIRED, null, new String[]{REQUIRED, DISABLED});
        addExecInfo(execs, "Password Validation", "registration-password-action", false, 1, 3, REQUIRED, null, new String[]{REQUIRED, DISABLED});
        addExecInfo(execs, "Recaptcha", "registration-recaptcha-action", true, 1, 4, DISABLED, null, new String[]{REQUIRED, DISABLED});
        expected.add(new FlowExecutions(flow, execs));
